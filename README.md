...
| `currencyOptions`     | `array of strings`  | Defines the set of values in the currency switcher dropdown. [MORE INFO](#details-currency-options)  | `['SATS', 'BTC']`          | `['SATS', 'BTC', 'USD', 'EUR', 'CAD', 'AUD']` |
