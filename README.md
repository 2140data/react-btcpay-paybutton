...
| `currencyOptions`     | `array of strings`  | Defines the set of currencies in the dropdown selections. [MORE INFO](#details-currency-options)  | `['SATS', 'BTC']`          | `['SATS', 'BTC', 'USD', 'EUR', 'CAD', 'AUD']` |
